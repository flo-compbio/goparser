...
.. |docs-latest| image:: http://readthedocs.org/projects/goparser/badge/?version=latest&random=1
    :alt: Documentation Status (master branch)
    :scale: 100%
    :target: https://goparser.readthedocs.org/en/latest/?badge=latest

.. |docs-develop| image:: http://readthedocs.org/projects/goparser/badge/?version=develop&random=1
