# -*- coding: utf-8 -*-
#
# GOparser documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'GOparser.tex', u'GOparser Documentation',
...
man_pages = [
    (master_doc, 'goparser', u'GOparser Documentation',
     [author], 1),
]
...
texinfo_documents = [
  (master_doc, 'GOparser', u'GOparser Documentation',
   author, 'GOparser', 'One line description of project.',
   'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    'genometools': ('https://genometools.readthedocs.org/en/latest', None),
}
